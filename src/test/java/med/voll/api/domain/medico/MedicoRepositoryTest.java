...
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver null quando unico medico cadastrado não está" +
            "disponível na data")
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var medico = cadastrarMedico("Carlos", "carlos@voll.med", "12345", Especialidade.CARDIOLOGIA);
